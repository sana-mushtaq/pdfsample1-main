...
!(function (y, M, L, a) {
    (y.fn.flipBook = function (e) {
        ...
        (y.fn.flipBook.options = {
            ...
            btnAutoplay: { enabled: !1, title: "Autoplay", icon: "fa-play", icon2: "play_arrow", iconAlt: "fa-pause", iconAlt2: "pause" },
            btnSearch: { enabled: !0, title: "Search", icon: "fas fa-search", icon2: "search" },
            ...
            btnToc: { enabled: !1, title: "Table of Contents", icon: "fa-list-ol", icon2: "toc" },
            ...
            btnPrint: { enabled: !1, title: "Print", icon: "fa-print", icon2: "print", hideOnMobile: !0 },
            btnDownloadPages: { enabled: !1, title: "Download pages", icon: "fa-download", icon2: "file_download", url: "images/pages.zip", name: "allPages.zip" },
            btnDownloadPdf: { forceDownload: !0, enabled: !1, title: "Download PDF", icon: "fa-file", icon2: "picture_as_pdf", url: null, openInNewWindow: !0, name: "allPages.pdf" },
        ...
        (FLIPBOOK.Main.prototype = {
            ...
            updateCurrentPage: function () {
                setTimeout(() => {
                    ...
                    // Adjusting index for right-to-left mode
                    i % 2 == 1 && i++;
                    t && (i = this.options.pages.length - i);

                    var  hashValue = 0;

                    if(window.globalVariable.length===0) {
                         
                        window.globalVariable = [0];

                    }
                    hashValue = window.globalVariable[0];

                    if(window.globalVariable.length === 2) {

                        hashValue = window.globalVariable[1];
                    }
                                
                    if (hashValue) {
                        // Parse the hash value to get the desired page number or range
                        e = parseInt(hashValue, 10);

                        // Set the initial PDF page based on the hash value
                        if (this.Book.setCurrentPageNumber) {
                            this.Book.setCurrentPageNumber(e);
                        }
            
                        // Continue with the rest of the code...
                        if (this.options.singlePageMode || this.Book.singlePage || 1 == this.Book.view) {
                            this.setHash(e);
                            this.cPage = [e - 1];
                        } else {
                            if (o < e || (e == o && o % 2 == 0)) {
                        ...
                        // Continue with the rest of the code...
                        t ? (this.enableNext(0 < e && e < o - 1), this.enablePrev(e > 1)) : (this.enablePrev(e > 0), this.enableNext(e < o - 1));
                        this.wrapper.find(".c-l-p, .c-r-p, .c-p").toggle(this.cPage.length === 2);
            
                        window.globalVariable = this.cPage;
            
                        let numbersCPage = this.cPage.map(cPageItem => cPageItem + 1);
                        let xs = numbersCPage.join("-");
                        this.currentPageValue = xs;
                        ...
                        if (this.currentPage !== undefined) {
                            ...
                            if (e !== this.currentPageValue) {
                                ...
                                // Google Analytics tracking (if gaCode is defined)
                                if (this.gaCode) {
                                    ga("send", {
                                        hitType: "event",
                        ...
                        console.log("jksjkj")
                        // Handle single page mode or two-page mode as before
                        this.options.singlePageMode || this.Book.singlePage || 1 == this.Book.view
                            ...
                            : (o < i || (i == o && o % 2 == 0) ? ((e = o), (this.cPage = [o - 1])) : i < 1 ? ((e = 1), (this.cPage = [0])) : ((e = i), (this.cPage = [i - 1, i])), this.setHash(e));
            ...
            onBookCreated: function () {
                ...
                console.log(window.globalVariable[0]+1)
                var e = this.options,
                    t = this;
                e.rightToLeft ? t.goToPage(Number(e.pages.length - Number(e.startPage) + 1), !0) : t.goToPage(Number(window.globalVariable[0]+1), !0),
                    y(M).resize(function () {
                        t.resize();
                    }),
                    t.resize(),
            ...
            createMenu: function () {
                if (!this.menuBottom) {
                    ...
                    (this.menuBottom = y(L.createElement("div"))
                        ...
                        (this.menuBC = y(L.createElement("div")).addClass("flipbook-menu flipbook-menu-center").appendTo(this.menuBottom)),
                        ...
                        (this.menuTC = y(L.createElement("div")).addClass("flipbook-menu flipbook-menu-center").appendTo(this.menuTop)),
...
//                        this.toggleShareMenu();
            ...
            nextPage: function () {
                window.globalVariable[0] = window.globalVariable[0] + 2
                window.globalVariable[1] = window.globalVariable[1] + 2
...
function currentPageClient() {
    return window.globalVariable;
}

function shareButtonClicked() {console.log("hello");

        // Toggle the visibility of the container box
        var shareContainer = document.getElementById('shareContainer');
        shareContainer.style.display = (shareContainer.style.display === 'none' || shareContainer.style.display === '') ? 'block' : 'none';

        var gb = document.getElementById('overlay');
